...
const socialLinks = [
  ...
  },
  {
    ...
    ariaLabel: "Telegram - Homoeo Helpline",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 24 24"
...
const communityLinks = [
  { name: "MedyFacts WhatsApp Channel", href: "https://whatsapp.com/channel/0029Vb5VAylJf05gA0p75W1Q" },
  { name: "Homoeo Helpline WhatsApp", href: "https://whatsapp.com/channel/0029VaAXIzo9Bb65xfcj0F1F" },
  { name: "Telegram Channel", href: "https://t.me/homoeohelpline" },
  { name: "Telegram Group", href: "https://t.me/joinchat/AAAAAEccesEl2BWAhnN0rg" },
];
      ...
      <div className="container-content section-padding-sm">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div>
            ...
            <p className="text-fluid-caption text-foreground-muted mb-2">Stay connected for AYUSH & Homoeopathy updates:</p>
              ...
              {communityLinks.map((link) => (
                <li key={link.name}>
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-foreground-muted hover:text-primary text-fluid-caption transition-colors"
                  >
                    {link.name} →
                  </a>
                </li>
