    ...
    >
      <div className="container-content flex items-center justify-between h-16 md:h-18">
        ...
        <div className="flex items-center gap-1">
          {/* Appointment button - hidden on mobile (too cramped), visible on md+ */}
          <a
            href="#appointment"
            onClick={(e) => scrollToSection(e, "appointment")}
            className="hidden md:inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-full text-xs font-medium bg-primary text-primary-foreground hover:bg-primary-hover transition-colors shadow-sm"
          >
